        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            >
              <div className="w-24 h-auto sm:w-full sm:h-36 flex-shrink-0 relative overflow-hidden">
                <img
                  src="https://plus.unsplash.com/premium_photo-1697729549014-2faefb25efba?q=80&w=1375&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt=""
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            >
              <div className="w-24 h-auto sm:w-full sm:h-36 flex-shrink-0 relative overflow-hidden">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQt7u3V_P7752ScQ5lwHOOMd8qrEO2RuNvdZw&s"
                  alt=""
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {t.activities.map((activity, idx) => {
              ...
              const activityImages = [
                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSIgrrwostSBs-2yK0FCLr0c5psZzeWy4WKw&s',
