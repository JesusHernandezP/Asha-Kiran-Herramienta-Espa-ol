...
export const aulaVirtualTranslations: Record<Language, AulaTranslation> = {
  es: {
    ...
    quickResourcesTitle: 'Recursos Rápidos',
    glossaryTitle: 'Glosario Interactivo',
    glossaryDesc: 'Vocabulario, pronunciación y conjugaciones de todos los niveles.',
    resourcesTitle: 'Banco de Recursos',
    resourcesDesc: 'Fichas de lectura, audios de comprensión y materiales extra.',
    malagaTitle: 'Recursos de Málaga',
    malagaDesc: 'Guías locales y vocabulario práctico para el día a día en Málaga.',
    levels: {
      A1: {
        name: 'Inicial',
  ...
  en: {
    ...
    quickResourcesTitle: 'Quick Resources',
    glossaryTitle: 'Interactive Glossary',
    glossaryDesc: 'Vocabulary, pronunciation and conjugations for all levels.',
    resourcesTitle: 'Resource Hub',
    resourcesDesc: 'Reading worksheets, listening audios and extra materials.',
    malagaTitle: 'Malaga Resources',
    malagaDesc: 'Local guides and practical vocabulary for daily life in Malaga.',
    levels: {
      A1: {
        name: 'Beginner',
  ...
  ar: {
    ...
    quickResourcesTitle: 'الموارد السريعة',
    glossaryTitle: 'قاموس تفاعلي',
    glossaryDesc: 'المفردات والنطق والتصريفات لجميع المستويات.',
    resourcesTitle: 'مركز الموارد',
    resourcesDesc: 'أوراق العمل القرائية، والملفات الصوتية والمواد الإضافية.',
    malagaTitle: 'موارد مالقة',
    malagaDesc: 'الدلائل المحلية والمفردات العملية للحياة اليومية في مالقة.',
    levels: {
      A1: {
        name: 'مبتدئ',
  ...
  uk: {
    ...
    quickResourcesTitle: 'Швидкі ресурси',
    glossaryTitle: 'Інтерактивний глосарій',
    glossaryDesc: 'Лексика, вимова та відмінювання дієслів для всіх рівнів.',
    resourcesTitle: 'Центр ресурсів',
    resourcesDesc: 'Матеріали для читання, аудіо для аудіювання та додаткові файли.',
    malagaTitle: 'Ресурси Малаги',
    malagaDesc: 'Локальні путівники та корисна лексика для життя в Малазі.',
    levels: {
      A1: {
        name: 'Початковий',
  ...
  fr: {
    ...
    quickResourcesTitle: 'Ressources Rapides',
    glossaryTitle: 'Glossaire Interactif',
    glossaryDesc: 'Vocabulaire, prononciation et conjugaisons pour tous les niveaux.',
    resourcesTitle: 'Banque de Ressources',
    resourcesDesc: 'Fiches de lecture, audios de compréhension et matériel supplémentaire.',
    malagaTitle: 'Ressources de Malaga',
    malagaDesc: 'Guides locaux et vocabulaire pratique pour la vie quotidienne à Malaga.',
    levels: {
      A1: {
        name: 'Débutant',
